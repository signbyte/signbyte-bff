...
{ "title": "contract", "slots": [ { "orderIndex": 1, "identityRef": "XXXXXX-XXXXX", "country": "LV" } ] }
```

The envelope service is asked to store `PNOLV-XXXXXXXXXXX`. The same applies to
...
reduced to the one canonical spelling first. A person invited as `PNOLV-XXXXXX-XXXXX` who signs in
with a card whose certificate spells it `PNOLV-XXXXXXXXXXX` is now shown their slot; before, they
